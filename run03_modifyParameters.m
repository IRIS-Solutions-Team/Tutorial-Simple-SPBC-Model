%% Assign and change parameters and steady-state values
%
...
% constructor function `Model.fromFile( )`, by using the option
% `assign=`.
...
disp("Check steady state: fails to hold");
[flag, listEquations] = checkSteady(m, "error", false)
