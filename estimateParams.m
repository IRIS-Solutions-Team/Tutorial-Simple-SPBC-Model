...
%{
[summary1, pos1, C1, H1, mest1, v1, delta1, Pdelta1] = estimate( ...
    m, dd, startHist:endHist, estimSpecs ...
    , 'Filter=', filterOpt ...
    , 'Summary=', 'Table' ...
);
%}

save mat/estimate_params.mat mest
...
save mat/estimateParams.mat mest pos estimSpecs theta logpost s
